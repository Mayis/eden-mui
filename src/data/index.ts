...
export const home = {
  ...
  backImg: "https://eden.am/images/1672496510523--mainBack.webp"
};
  ...
  parts: [
    {
      ...
      nameArm: "Լիլիթ Հակոբջանյան",
      posArm: "Մենեջեր",
      descArm:
        "Լիլիթ Հակոբջանյանն է։ Մեր մենեջեր և ադմինիստրատոր։ Մասնագիտությամբ բիոքիմիկ է ինչը ավելի է օգնում հասկանալ միջամտությունները և մանրամանսել միջամտությունների մասին։ Աջակցում է հաճախորդներին որպեսզի նրանց այցը eden լինի ավելի հաճելի և հարմար։"
    },
    {
      id: 2,
      name: "Siroon Minas",
      ...
      nameArm: "Սիրուն Մինաս",
      posArm: "Տնօրեն- Պլաստիկ Վիրաբույժ",
      descArm:
        "Սիրուն Մինասն է ` Eden-ի հիմնադիրը։ Մասնագիտությամբ պլաստիկ վիրաբույժ է: Ավարտել է և ստացել բժշկի կոչում Երևանի Հերացու անվան Պետական Բժշկական Համալսարանում։ Eden-ում կատարում է մինիմալ ինվազիվ միջամտություններ ինչպիսիք են՝ բոտոքս, կունտուրային պլաստիկա, մեզոթերապիա, պլազմոթերապիա, բիոռևիտալիզացիաներ: Ինչպես նաև կատարում է տեղային անզգայացմամբ վիրահատական միջամտություններ ինչպիսիք են օտոպլաստիկա, բլեֆառոպլաստիկա։ Բժիշկ Սիրուն Մինասը նաև դասավանդում է կլինիկայում “ներարկումային կոսմետոլոգիա” դասընթացը:"
    },
    {
      id: 3,
...
export const contact = {
  adress: ["Gevorg Kochar 21, Yerevan", "Everyday 10:00 - 20:00", "+374 41 888 405"]
};
